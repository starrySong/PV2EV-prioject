...
import logoDark from '../assets/images/PLUG_DARK.png';
import logoDarkSm from '../assets/images/logo_sm_dark.png';
import logo from '../assets/images/PLUG.png';
import helpBoxImage from '../assets/images/help-icon.svg';
import profileImg from '../assets/images/users/userSong.png';
            ...
            {!hideUserProfile && (
                <div className="leftbar-user">
                    <Link to="/">
                        ...
                        <span className="leftbar-user-name">한전이</span>
                    </Link>
                </div>
            )}
