...
class Line extends React.Component {
  ...
  render() {
    return loadingContainerWrapper(this.props, this.props.loadingState || this.props.chart.loading(), React.createElement('div', { className: 'line-container', ref: this._setRef }));
  }
}
