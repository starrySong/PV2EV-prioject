...
class Bar extends Component {
  ...
  render() {
    ...
    return loadingContainerWrapper(this.props, this.props.loadingState || this.props.chart.loading(), React.createElement('div', { className: 'bar-container', ref: this._setRef }));
  }
}
