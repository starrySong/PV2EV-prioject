...
export default class Donut extends Component {
  ...
  render() {
    return loadingContainerWrapper(this.props, this.props.loadingState || this.props.chart.loading(), React.createElement('div', { className: 'donut-container', ref: this._setRef }));
  }
}
Donut.propTypes = {
  /**
